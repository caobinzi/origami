...
object FoldableMSpec extends Properties("FoldableM") {
  ...
  property("break law for FoldableM - input stream instance") = inputStreamFoldableMBreakLaw
  ...
  def inputStreamFoldableMBreakLaw = forAll { (s: String, fold: F[Bytes, String] { type S = Int }) =>
